  ...
  <body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
    <header class="app-header navbar">
      ...
      <a class="navbar-brand" href="#">
        <img class="navbar-brand-full"  src="<?php echo base_url('core-ui/img/brand/logo.svg'); ?>" width="89" height="25" alt="CoreUI Logo">
      ...
      <ul class="nav navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
            <img class="img-avatar"  src="<?php echo base_url('core-ui/img/avatars/6.jpg'); ?>" alt="admin@bootstrapmaster.com">
          </a>
                      ...
                      <tbody>
                        <tr>
                          <td class="text-center">
                            <div class="avatar">
                              <img  src="<?php echo base_url('core-ui/img/avatars/1.jpg'); ?>" class="img-avatar" alt="admin@bootstrapmaster.com">
                        ...
                        <tr>
                          <td class="text-center">
                            <div class="avatar">
                              <img  src="<?php echo base_url('core-ui/img/avatars/2.jpg'); ?>" class="img-avatar" alt="admin@bootstrapmaster.com">
                        ...
                        <tr>
                          <td class="text-center">
                            <div class="avatar">
                              <img  src="<?php echo base_url('core-ui/img/avatars/3.jpg'); ?>" class="img-avatar" alt="admin@bootstrapmaster.com">
                        ...
                        <tr>
                          <td class="text-center">
                            <div class="avatar">
                              <img  src="<?php echo base_url('core-ui/img/avatars/4.jpg'); ?>" class="img-avatar" alt="admin@bootstrapmaster.com">
                        ...
                        <tr>
                          <td class="text-center">
                            <div class="avatar">
                              <img  src="<?php echo base_url('core-ui/img/avatars/5.jpg'); ?>" class="img-avatar" alt="admin@bootstrapmaster.com">
                              <span class="avatar-status badge-success"></span>
                            </div>
                          </td>
                          <td>
                        ...
                        <tr>
                          <td class="text-center">
                            <div class="avatar">
                              <img  src="<?php echo base_url('core-ui/img/avatars/6.jpg'); ?>" class="img-avatar" alt="admin@bootstrapmaster.com">
                              <span class="avatar-status badge-danger"></span>
                            </div>
                          </td>
                          <td>
            ...
            <div class="list-group list-group-accent">
              ...
              <div class="list-group-item list-group-item-accent-warning list-group-item-divider">
                <div class="avatar float-right">
                  <img class="img-avatar"  src="<?php echo base_url('core-ui/img/avatars/7.jpg'); ?>" alt="admin@bootstrapmaster.com">
                </div>
                <div>Meeting with
                  <strong>Lucas</strong>
                </div>
              ...
              <div class="list-group-item list-group-item-accent-info">
                <div class="avatar float-right">
                  <img class="img-avatar"  src="<?php echo base_url('core-ui/img/avatars/4.jpg'); ?>" alt="admin@bootstrapmaster.com">
                </div>
                <div>Skype with
                  <strong>Megan</strong>
                </div>
              ...
              <div class="list-group-item list-group-item-accent-danger list-group-item-divider">
                ...
                <div class="avatars-stack mt-2">
                  <div class="avatar avatar-xs">
                    <img class="img-avatar"  src="<?php echo base_url('core-ui/img/avatars/2.jpg'); ?>" alt="admin@bootstrapmaster.com">
                  </div>
                  <div class="avatar avatar-xs">
                    <img class="img-avatar"  src="<?php echo base_url('core-ui/img/avatars/3.jpg'); ?>" alt="admin@bootstrapmaster.com">
                  </div>
                  <div class="avatar avatar-xs">
                    <img class="img-avatar"  src="<?php echo base_url('core-ui/img/avatars/4.jpg'); ?>" alt="admin@bootstrapmaster.com">
                  </div>
                  <div class="avatar avatar-xs">
                    <img class="img-avatar"  src="<?php echo base_url('core-ui/img/avatars/5.jpg'); ?>" alt="admin@bootstrapmaster.com">
                  </div>
                  <div class="avatar avatar-xs">
                    <img class="img-avatar"  src="<?php echo base_url('core-ui/img/avatars/6.jpg'); ?>" alt="admin@bootstrapmaster.com">
                  </div>
              ...
              <div class="list-group-item list-group-item-accent-primary list-group-item-divider">
                ...
                <div class="avatars-stack mt-2">
                  ...
                  <div class="avatar avatar-xs">
                    <img class="img-avatar"  src="<?php echo base_url('core-ui/img/avatars/8.jpg'); ?>" alt="admin@bootstrapmaster.com">
                  </div>
                </div>
              </div>
            </div>
